...
app.post("/", express.json(), async (req, res) => {
    ...
    messages.unshift({
        role: "system",
        content: `Start every response with the user's name, which is @${user.data.login} and include references to the concept of 'the force' from Star Wars movies in your responses.`,
    });
